...
namespace PTC.Controller.Usuarios
{
    class ControllerAdminUsuarios
    {
        ...
        private void VerUsuario(object sender, EventArgs e)
        {
            ...
            ViewAgregarUsuario openForm = new ViewAgregarUsuario(3, Nombre, PersonalID, rol, EspecialidadID, Telefono, consultorioID, UsuarioPersonal, contraseñaPersonal, email);
            openForm.ShowDialog();
            RefrescarData();
        }
